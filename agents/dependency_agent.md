# dependency_agent — Rôle & Procédures

## Mission
Gérer les dépendances (IDF components, submodules).

## Périmètre
Mise à jour/gel `idf_component.yml`, submodules, `dependencies.lock`.

## Livrables
- `dependencies.lock` à jour, notes de compatibilité.
...
## Checks (obligatoires)
- `idf.py reconfigure` passe ; build à blanc ; reproductibilité Docker.
