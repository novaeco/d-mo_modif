# config_agent — Rôle & Procédures

## Mission
Configurer `sdkconfig`, `partitions.csv`.

## Périmètre
PSRAM, couleur LVGL, OTA, tailles partitions.

## Livrables
- Configs stables par cible ; diffs documentés.
...
## Checks (obligatoires)
- Firmware tient dans partitions ; options critiques activées.
