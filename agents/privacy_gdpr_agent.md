# privacy_gdpr_agent — Rôle & Procédures

## Mission
Vie privée/RGPD (si données).

## Périmètre
Minimisation, anonymisation, consentement.

## Livrables
- Politique données + hooks.
...
## Checks (obligatoires)
- Conformité RGPD ; aucun PII non nécessaire.
