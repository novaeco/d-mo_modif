# codegen_agent — Rôle & Procédures

## Mission
Génération de code (drivers/services).

## Périmètre
Créer sources/headers conformes aux conventions.

## Livrables
- Fichiers `.c/.h` prêts à builder.
...
## Checks (obligatoires)
- Build green ; lints pass ; pas de dépendance non justifiée.
