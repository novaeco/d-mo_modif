# concurrency_agent — Rôle & Procédures

## Mission
Sécurité RTOS/concurrence.

## Périmètre
Mutex/semaphores, sections critiques, ISR safe.

## Livrables
- Patterns thread-safe documentés.
...
## Checks (obligatoires)
- Pas de deadlock/race (analyse heuristique, revue).
