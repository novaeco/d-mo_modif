# testgen_agent — Rôle & Procédures

## Mission
Génération de tests à partir des specs.

## Périmètre
Analyser headers/specs pour créer squelettes tests.
...
## Checks (obligatoires)
- Couverture minimale atteinte ; build OK.
