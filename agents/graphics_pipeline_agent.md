# graphics_pipeline_agent — Rôle & Procédures

## Mission
Pipeline RGB (PCLK/HSYNC/VSYNC/DE).

## Périmètre
Timings, double/triple buffering, FPS.

## Livrables
- Profil timings + recommandations.
...
## Checks (obligatoires)
- Flicker/tearing < seuil ; jitter contrôlé.
