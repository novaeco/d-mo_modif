# dma_agent — Rôle & Procédures

## Mission
Chemins DMA & cohérence cache.

## Périmètre
Alignements, buffers DMA (I2S/LCD), IRAM/DRAM.

## Livrables
- Buffers conformes + doc d’allocation.
...
## Checks (obligatoires)
- Pas de violation ISR ; perf stable.
