# protocol_agent — Rôle & Procédures

## Mission
Bus/protocoles (CAN/RS485/USB framing).

## Périmètre
Cadencement, framing, CRC.

## Livrables
- Stacks protocoles robustes.
...
## Checks (obligatoires)
- Pas de perte de trame ; débit conforme.
