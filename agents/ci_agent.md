# ci_agent — Rôle & Procédures

## Mission
Workflows GitHub Actions.

## Périmètre
Jobs build/test/smoke/size/release, caches, artefacts.

## Livrables
- YAML CI par phase, artefacts publiés.
...
## Checks (obligatoires)
- Durée raisonnable ; caches efficaces ; logs clairs.
